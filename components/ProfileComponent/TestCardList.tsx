...
// import DynamicTestCard from "./TestCard";
// import { Eye, Copy, Trash } from "lucide-react";
// import {  useDeleteUserTestMutation } from "@/redux/service/test";
// import { useGetAllUserTestQuery } from "@/redux/feature/assessment/result";
// import Pagination from "./Pagination";
...
//     page_size: itemsPerPage,
//   });
//   console.log("data for test",data?.payload.tests)
//   // Delete mutation
//   const [deleteUserTest] = useDeleteUserTestMutation();
...
//         router.push(`/test-result/${type}/${uuid}`); // Correct route
//       },
